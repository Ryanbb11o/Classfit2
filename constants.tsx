...
export const TRANSLATIONS = {
  bg: {
    ...
    locationDesc: 'Намираме се във Варна, в района на сп. „Мир“.',
  ...
  en: {
    ...
    locationDesc: 'Located in Varna, near bus stop "Mir".',
